    ...
    <div class="modal-dialog">
        <form id="editarColorForm" method="POST" action="{{ route('admin.color.update', ':cod') }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" id="edit_cod" name="cod" value="">
                    <div class="mb-3">
                        <label for="edit_nombre" class="form-label">Nombre de Color</label>
                        <input type="text" class="form-control" id="edit_nombre" name="nombre" required>
                    </div>
                    <div class="mb-3">
                        <label for="codigo_c" class="form-label">Seleccione un Color</label>
                        <input type="color" class="form-control" id="codigo_c" name="codigo_c"
                         required>
                    </div>
                </div>
                <div class="modal-footer">
