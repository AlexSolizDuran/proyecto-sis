...
<body>
    <div class="container">
        <h2 class="title">Reporte de Ganancia</h2>
            ...
            <tbody>
                @foreach ($resultados as $venta)
                    <tr>
                        ...
                        <td>{{ number_format($venta->costoPP, 2) }} Bs</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div class="summary">
            ...
            <div>Total Costo Promedio: {{ number_format($totalCostoPP, 2) }} Bs</div>
            <div style="font-size: 18px; font-weight: bold; color: #4CAF50;">Ganancia: {{ number_format($totalPrecio - $totalDescuento - $totalCostoPP , 2) }} Bs</div>
        </div>
    </div>
</body>
</html>
